...
\title{MATH 368/621 Fall 2019 Homework \#3}

\author{Professor Adam Kapelner} %STUDENTS: write your name here

\iftoggle{professormode}{
\date{Due under the door of KY604 11:59PM Friday, October 4, 2019 \\ \vspace{0.5cm} \small (this document last updated \today ~at \currenttime)}
}
...
\hardsubproblem{Find $f_T(t)$ using the convolution.}\spc{15}~\vspace{1cm}


\end{enumerate}


\problem{This question reviews the Exponential distribution and introduces the Erland distribution.}
...
\intermediatesubproblem{Show that for any exponential r.v. with rate parameter $\lambda$ the distribution is \qu{memoryless} meaning that for any $c$, a positive constant, $\cprob{X > x + c}{X > c} = \prob{X > x}$.}\spc{3}
