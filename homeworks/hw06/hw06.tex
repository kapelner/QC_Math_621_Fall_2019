...
Reading is still \textit{required}. For this homework set, read on your own about multivariate characteristics functions, the central limit theorem, the normal, chi-squared, F, T, MVN distributions and the Z, T and F tests.
