...
\intermediatesubproblem{If we are to only consider atheists and Mormons, there are about 10M atheists in the American population and about 7M Mormons in the American population. Create a r.v. $X$ which is 3.4 if Mormon and 1.6 if atheist and find its PMF.}\spc{2}
